...
var SocialLoginWeb = class _SocialLoginWeb extends WebPlugin {
  constructor() {
    var _a;
    super();
    ...
    if (localStorage.getItem(_SocialLoginWeb.OAUTH_STATE_KEY)) {
  ...
  handleOAuthRedirect() {
    ...
    if (accessToken && idToken) {
      localStorage.removeItem(_SocialLoginWeb.OAUTH_STATE_KEY);
    ...
    return new Promise((resolve, reject) => {
      ...
      google.accounts.id.prompt((notification) => {
        if (notification.isNotDisplayed() || notification.isSkippedMoment()) {
          ...
          this.fallbackToTraditionalOAuth(scopes, this.googleHostedDomain).then((r) => resolve({ provider: "google", result: r.result })).catch(reject);
        } else {
  ...
  async loginWithApple(options) {
    ...
    return new Promise((resolve, reject) => {
      ...
      AppleID.auth.signIn().then((res) => {
        ...
        const result = {
          profile: {
            user: ((_b = (_a2 = res.user) === null || _a2 === void 0 ? void 0 : _a2.name) === null || _b === void 0 ? void 0 : _b.firstName) ? `${res.user.name.firstName} ${res.user.name.lastName}` : "",
          ...
          accessToken: {
            ...
            // TODO: to fix and find the correct token
          },
  ...
  async fallbackToTraditionalOAuth(scopes, hostedDomain) {
    ...
    localStorage.setItem(_SocialLoginWeb.OAUTH_STATE_KEY, "true");
...
//# sourceMappingURL=web-RHR32BFU.js.map
